...
namespace Catalog.Application.Features.Brands.UpdateBrand
{
    ...
    public static class UpdateBrand
    {
        ...
        /// The command.
        /// </summary>
        public sealed record Command : IRequest<ErrorOr<BrandResponse>>
        {
            /// <summary>
            /// The id.
            /// </summary>
            ...
            public Command(UpdateBrandRequest updateBrandRequest)
            {
        ...
        /// The handler.
        /// </summary>
        public sealed class Handler : IRequestHandler<Command, ErrorOr<BrandResponse>>
        {
            /// <summary>
            /// The unit of work.
            /// </summary>
            ...
            public Handler(IUnitOfWork unitOfWork, IMapper mapper, IBrandCache cache, IBrandRepository brandRepository)
            {
